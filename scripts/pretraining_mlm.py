...
if __name__=='__main__':
    ...
    #测试
    #pretraining(4,'/data/dataset/new_loghub_MLM_eval.log','/data/dataset/new_loghub_MLM_eval.log','/data/pretrained/','/data/pretrained/','/data/pretrained/',1,0.0001,0.01,16,0.05,10000,100,0.15,-1)
